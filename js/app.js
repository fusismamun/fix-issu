...
const showProducts = (products) => {
  ...
  const productAdd = document.getElementById("all-products");
...
const updateTotal = () => {
  const getPriceAmount =getInputValue("price");
  const getDeliveryAmount= getInputValue("delivery-charge");
  const getTaxAmount = getInputValue("total-tax");
  const grandTotal = getPriceAmount + getDeliveryAmount + getTaxAmount;
